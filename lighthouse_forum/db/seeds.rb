...
Post.create!(
  ...
  author: "Steve Nash",
  text: <<-eos.gsub(/\s+/, " ").strip
    I remember watching Warren Russell (#14) play back when he just playing
...
Post.create!(
  ...
  text: "Never heard of this guy Khurram Virani, but he's not as cool as this Warren russell guy."
)